var vm = new Vue({
    ...
    methods: {
        send_sms_code: function () {
			...
			axios.post('http://127.0.0.1:8000/smscodes/', {
					// 向后端声明，请返回json数据
                    mobile : this.mobile,
        ...
        generate_image_code: function () {
            ...
            this.image_code_url = 'http://127.0.0.1:8000' + "/imagecode/" + this.image_code_id + "/";
        },
        check_username: function () {
			...
			if (this.error_name === false) {
				axios.get('http://127.0.0.1:8000/users/username/count/', {
				        params :{
        ...
        check_phone: function () {
            ...
            if (this.error_phone === false) {
				axios.get('http://127.0.0.1:8000/users/mobile/count/', {
				        params:{
				          mobile:this.mobile
                        },
						responseType: 'json',
